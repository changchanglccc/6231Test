 ...
 *
 */
public class LVL extends Server_Configuration implements ClientCalls{
	...
	public static void registerServer() {
		try {
			String server_name = LVL.SERVER_NAME;
			ClientCalls obj = new LVL();
	...
	public String getRecordCounts() throws RemoteException {
		int mtlSize = Integer.parseInt(getRecSzFromRemoteServer(Server_Configuration.getMTL_PORT()));
...
//			res = getRecSzStat(); // TODO
		...
		public static String checkManagerID(String managerID){
			for(String account: LVL.MANAGERLIST){
				if(account.equalsIgnoreCase(managerID)){
					LVL.ManagerID = managerID;
					return "valid";
				}
			}
			return "invalid";
